...
state_regulatory_costs = pd.read_csv('C:/Users/jdavis/OneDrive - ECONOMETRICA INC/Projects/TSA/Regulatory Database - Phase II/Python/Geo_Datasets/regulatory_costs.csv')
state_regulatory_costs['lookup'] = state_regulatory_costs['RIN'].map(str) + '-' + state_regulatory_costs['Regulatory_Action_Type'].map(str) + '-' + state_regulatory_costs['Portion'].map(str)
state_regulatory_costs.info()
