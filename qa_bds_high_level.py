...
#            framep.grid(row=5,column=0, columnspan=2)
        ...
        def var_window():
            ...
            var_select.labelt = tk.Label(window, text="Select Variables:", anchor="w", font="Arial 12 bold")
            ...
            labelcbp = tk.Label(var_select, text="CBP:", anchor="w",font="Arial 10 bold")
            labelbed = tk.Label(var_select, text="BED:", anchor="w",font="Arial 10 bold")
            labelbds = tk.Label(var_select, text="BDS:", anchor="w",font="Arial 10 bold")
            labelbits = tk.Label(var_select, text="BITS:", anchor="w",font="Arial 10 bold")
            
            labelcbp.grid(row=0,column=0)
            labelbed.grid(row=0,column=2)
            labelbds.grid(row=0,column=4)
            labelbits.grid(row=0,column=6)
            #CBP,BDS,BITS,BED
        #fill in variable cbp list box
            svCBP = tk.Scrollbar(var_select)
            svCBP.grid(row=1,column=1,sticky='ns')
            ...
            list_boxcbp.grid(row=1,column=0,sticky='nsew')
        ...
        #fill in variable bed list box
            ...
            svbed.grid(row=1,column=3,sticky='ns')
            ...
            list_boxbed.grid(row=1,column=2,sticky='nsew')
        ...
        #fill in variable bds list box
            ...
            svbds.grid(row=1,column=5,sticky='ns')
            ...
            list_boxbds.grid(row=1,column=4,sticky='nsew')
        ...
        #fill in variable bits list box
            ...
            svbits.grid(row=1,column=7,sticky='ns')
            ...
            list_boxbits.grid(row=1,column=6,sticky='nsew')
            ...
            buttona.grid(row=2,column=0, columnspan=3)
            buttonr = tk.Button(var_select, text = "Restart", command = restart)
            buttonr.grid(row=2,column=4, columnspan=3)
